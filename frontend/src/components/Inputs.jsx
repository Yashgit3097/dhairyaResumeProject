...
import { inputStyles, photoSelectorStyles, inputStyles as styles, titleInputStyles } from '../assets/dummystyle.js';
...
export const Input = ({value, onChange, placeholder, label, type = "text",}) => {
    ...
    const styles = inputStyles;  // Use the imported styles

  return (
    <div className={styles.wrapper}>
        {label && <label className={styles.label}>{label}</label>}
        <div className={styles.inputContainer(isFocused)}>
            {/* here  we are using a conditional rendering to show the input type as text or password based on the type prop */}
            {/* if the type is password then we will show the eye icon to toggle the password visibility */}
            {/* if the type is not password then we will show the input field as it is */}
            <input
...
// Used in Edit Resume as a title input component
